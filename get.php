...
$addons = array(
	...
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/10.0-dev/clipContentsDesigner-10.0-dev.nvda-addon",
	...
	"devtoolkit" => "developer-toolkit-0.1.1-beta.nvda-addon",
	...
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/10.0-dev/emoticons-10.0-dev.nvda-addon",
	...
	"nvda3208" => "addonUpdater-19.06.nvda-addon",
	...
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/13.1-dev/placeMarkers-13.1-dev.nvda-addon",
	...
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/7.1-dev/readFeeds-7.1-dev.nvda-addon",
	"rf-o" => "https://github.com/nvdaes/readFeeds/releases/download/4.5/readFeeds-4.5.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/19.05/resourceMonitor-19.05A.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/19.05/resourceMonitor-19.05A.nvda-addon",
	...
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/19.06/stationPlaylist-19.06.nvda-addon",
	"spl-lts18" => "https://github.com/josephsl/stationPlaylist/releases/download/19.06/stationPlaylist-18.09.9-lts.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/19.06/wintenApps-19.06.2.nvda-addon",
	...
	"wetp" => "http://www.nvda.it/files/plugin/weather_plus6.5.nvda-addon",
