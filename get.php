...
$addons = array(
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.1/clipContentsDesigner-8.1.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.1/clipContentsDesigner-8.1.nvda-addon",
	...
	"dw" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v5.2/dayOfTheWeek-5.2.nvda-addon",
	"dw-dev" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v5.2/dayOfTheWeek-5.2.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.12/eMule-3.12.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.12/eMule-3.12.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/7.1/emoticons-7.1.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/8.1-dev/emoticons-8.1-dev.nvda-addon",
	...
	"gwv" => "https://github.com/josephsl/goldWave/releases/download/18.07/goldwave-18.07.nvda-addon",
	...
	"nvda3208" => "addonUpdater-20180827A.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/10.2/placeMarkers-10.2.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/11.0-dev/placeMarkers-11.0-dev.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/4.5/readFeeds-4.5.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/5.0-dev/readFeeds-5.0-dev.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/18.07/resourceMonitor-18.07.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/18.07/resourceMonitor-18.07.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/4.1/reportSymbols-4.1.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/4.1/reportSymbols-4.1.nvda-addon",
	"sentencenav" => "https://github.com/mltony/nvda-sentence-nav/releases/download/v1.1/SentenceNav-1.1.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/18.08.2/stationPlaylist-18.08.2.nvda-addon",
	"spl-lts18" => "https://github.com/josephsl/stationPlaylist/releases/download/18.08.2/stationPlaylist-18.08.2.nvda-addon",
	...
	"tbx" => "toolbarsExplorer-1.0-20180828-dev.nvda-addon",
	"tbx-dev" => "toolbarsExplorer-1.0-20180828-dev.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/18.08/wintenApps-18.08.1.nvda-addon",
