...
$addons = array(
	...
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/6.4-dev/clipContentsDesigner-6.4-dev.nvda-addon",
	"ckbl" => "https://github.com/abdel792/sayCurrentKeyboardLanguage/releases/download/v1.2/sayCurrentKeyboardLanguage-1.2.nvda-addon",
	...
	"dw" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v2.0/dayOfTheWeek-2.0.nvda-addon",
	"dw-dev" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v2.0/dayOfTheWeek-2.0.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.6/eMule-3.6.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.6/eMule-3.6.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/5.6/emoticons-5.6.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/5.6/emoticons-5.6.nvda-addon",
	"etn" => "easyTableNavigator-1.1.nvda-addon",
	"etn-dev" => "easyTableNavigator-1.0-dev.nvda-addon",
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/17.07.1/enhancedTouchGestures-17.07.1.nvda-addon",
	"ets-dev" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/17.07/enhancedTouchGestures-17.07.nvda-addon",
	...
	"gc" => "goldenCursor-1.2.nvda-addon",
	"gc-dev" => "goldenCursor-1.2.nvda-addon",
	"gl" => "https://github.com/nvdaaddons/nvdaaddons.github.io/wiki/guideLines",
	"gwv" => "https://github.com/josephsl/goldWave/releases/download/17.05/goldwave-17.05.nvda-addon",
	"gwv-dev" => "https://github.com/josephsl/goldWave/releases/download/17.05/goldwave-17.05.nvda-addon",
	"it" => "instantTranslate-4.1-dev.nvda-addon",
	"it-dev" => "instantTranslate-4.1-dev.nvda-addon",
	"lambda" => "https://lambda-nvda.github.io/stable_broker.html",
	"lambda-dev" => "https://lambda-nvda.github.io/dev_broker.html",
	"mp3dc" => "https://github.com/abdel792/mp3DirectCut/releases/download/v3.1/mp3DirectCut-3.1.nvda-addon",
	"mp3dc-dev" => "https://github.com/abdel792/mp3DirectCut/releases/download/v3.1/mp3DirectCut-3.1.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/8.2/placeMarkers-8.2.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/8.2/placeMarkers-8.2.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/3.4/readFeeds-3.4.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/3.4/readFeeds-3.4.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/17.09/resourceMonitor-17.09.nvda-addon",
	"rm-dev" => "resourceMonitor-20170419-dev.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/3.1/reportSymbols-3.1.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/3.1/reportSymbols-3.1.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/17.09.1/stationPlaylist-17.09.1.nvda-addon",
	...
	"ubi" => "unicodeBrailleInput-2.6.nvda-addon",
	"ubi-dev" => "unicodeBrailleInput-2.6.nvda-addon",
	"VR" => "virtualRevision-2.2.nvda-addon",
	"vlc" => "vlc-1.3.nvda-addon",
	"vent" => "Ventrilo-1.0-dev.nvda-addon",
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/17.09.1/wintenApps-17.09.1.nvda-addon",
	"w10-dev" => "http://www.josephsl.net/files/nvdaaddons/getupdate.php?file=w10-dev",
	"wetp" => "http://www.nvda.it/files/plugin/weather_plus4.5.nvda-addon",
