...
$addons = array(
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/6.3/clipContentsDesigner-6.3.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/6.3/clipContentsDesigner-6.3.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.8/eMule-3.8.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.8/eMule-3.8.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/6.1/emoticons-6.1.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/6.1/emoticons-6.1.nvda-addon",
	...
	"gc" => "goldenCursor-2.1.nvda-addon",
	"gc-dev" => "goldenCursor-2.1.nvda-addon",
	...
	"mp3dc-dev" => "https://github.com/abdel792/mp3DirectCut/releases/download/v4.0-dev/mp3DirectCut-4.0-dev.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/8.4/placeMarkers-8.4.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/8.4/placeMarkers-8.4.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/4.0/readFeeds-4.0.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/4.0/readFeeds-4.0.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/17.12/resourceMonitor-17.12.nvda-addon",
	"rm-dev" => "resourceMonitor-20170419-dev.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/3.3/reportSymbols-3.3.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/3.3/reportSymbols-3.3.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/18.01/stationPlaylist-18.01.nvda-addon",
	...
	"vsb" => "https://github.com/nvdaes/vitalsourcebookshelf/releases/download/1.2/vitalSourceBookshelf-1.2.nvda-addon",
	"vsb-dev" => "https://github.com/nvdaes/vitalsourcebookshelf/releases/download/1.2/vitalSourceBookshelf-1.2.nvda-addon",
	"vlc" => "vlc-1.3.nvda-addon",
	"vent" => "Ventrilo-1.0-dev.nvda-addon",
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/18.01/wintenApps-18.01.nvda-addon",
