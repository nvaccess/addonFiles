...
$addons = array(
	...
	"em" => "https://github.com/nvdaaddons/eMule/releases/download/3.2/eMule-3.2.nvda-addon",
	"em-dev" => "https://github.com/nvdaaddons/eMule/releases/download/3.2/eMule-3.2.nvda-addon",
	"emo" => "https://github.com/nvdaaddons/emoticons/releases/download/4.6/emoticons-4.6.nvda-addon",
	"emo-dev" => "https://github.com/nvdaaddons/emoticons/releases/download/4.6/emoticons-4.6.nvda-addon",
	...
	"pm" => "https://github.com/nvdaaddons/placeMarkers/releases/download/6.4/placeMarkers-6.4.nvda-addon",
	"pm-dev" => "https://github.com/nvdaaddons/placeMarkers/releases/download/6.4/placeMarkers-6.4.nvda-addon",
	"qb-dev" => "http://files.nvaccess.org/nvda-addons/quickBooks2014-2014.4.7.nvda-addon",
	"rf" => "https://github.com/nvdaaddons/readFeeds/releases/download/2.9/readFeeds-2.9.nvda-addon",
	"rf-dev" => "https://github.com/nvdaaddons/readFeeds/releases/download/2.9/readFeeds-2.9.nvda-addon",
