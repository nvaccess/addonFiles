<?php
$addons = array(
	"bc" => "bitChe-2.0.nvda-addon",
	"bc-dev" => "bitChe-2.0.nvda-addon",
	...
	"emo" => "emoticons-2.0.nvda-addon",
	"emo-dev" => "emoticons-2.0-dev.nvda-addon",
	"ets" => "enhancedTouchGestures-0.2.nvda-addon",
	"ew" => "extendedWinamp-1.1.nvda-addon",
	"fh" => "focusHighlight-2.0.nvda-addon",
