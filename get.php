...
$addons = array(
	...
	"gc" => "https://github.com/nvda-es/goldenCursor/releases/download/6.1/goldenCursor-6.1.nvda-addon",
	"gc-dev" => "https://github.com/nvda-es/goldenCursor/releases/download/6.1/goldenCursor-6.1.nvda-addon",
