...
$addons = array(
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.3/clipContentsDesigner-8.3.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.3/clipContentsDesigner-8.3.nvda-addon",
	...
	"dw" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.0/dayOfTheWeek-6.0.nvda-addon",
	"dw-dev" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.0/dayOfTheWeek-6.0.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.14/eMule-3.14.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.14/eMule-3.14.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/8.1/emoticons-8.1.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/8.1/emoticons-8.1.nvda-addon",
	...
	"etn-dev" => "easyTableNavigator-1.1.nvda-addon",
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/18.08/enhancedTouchGestures-18.08.nvda-addon",
	"ets-dev" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/18.08/enhancedTouchGestures-18.08.nvda-addon",
	...
	"gc" => "goldenCursor-3.1.nvda-addon",
	"gc-dev" => "goldenCursor-3.1.nvda-addon",
	"gl" => "https://github.com/nvdaaddons/nvdaaddons.github.io/wiki/guideLines",
	"gwv" => "https://github.com/josephsl/goldWave/releases/download/18.10/goldwave-18.10.nvda-addon",
	"gwv-dev" => "https://github.com/josephsl/goldWave/releases/download/18.07/goldwave-18.07.nvda-addon",
	...
	"nvda3208" => "addonUpdater-20180928.nvda-addon",
	"nvda7857" => "screenCurtain-20180807.nvda-addon",
	"nvdaremote" => "https://nvdaremote.com/remote-2.2.nvda-addon",
	"objLoc" => "https://github.com/josephsl/objLocationTones/releases/download/18.10/objLocTones-18.10.nvda-addon",
	"objPad" => "https://github.com/josephsl/objPad/releases/download/18.10/objPad-18.10.nvda-addon",
	"objPad-dev" => "https://github.com/josephsl/objPad/releases/download/18.10/objPad-18.10.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/11.1/placeMarkers-11.1.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/11.1/placeMarkers-11.1.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/5.1/readFeeds-5.1.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/5.1/readFeeds-5.1.nvda-addon",
	"rf-o" => "https://github.com/nvdaes/readFeeds/releases/download/4.5/readFeeds-4.5.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/18.10/resourceMonitor-18.10.1.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/18.10/resourceMonitor-18.10.1.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/4.3/reportSymbols-4.3.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/4.3/reportSymbols-4.3.nvda-addon",
	"rsy-o" => "https://github.com/nvdaes/reportSymbols/releases/download/3.6/reportSymbols-3.6.nvda-addon",
	"sentencenav" => "https://github.com/mltony/nvda-sentence-nav/releases/download/v1.1/SentenceNav-1.1.nvda-addon",
	"spie" => "https://www.nvaccess.org/files/nvda-addons/speechPlayerInEspeak-0.4.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/18.10/stationPlaylist-18.10.3.nvda-addon",
	"spl-lts18" => "https://github.com/josephsl/stationPlaylist/releases/download/18.10/stationPlaylist-18.09.4A-lts.nvda-addon",
	...
	"st" => "systrayList-2.4.nvda-addon",
	"st-dev" => "systrayList-2.4.nvda-addon",
	...
	"tbx" => "toolbarsExplorer-1.0-20180914-dev.nvda-addon",
	"tbx-dev" => "toolbarsExplorer-1.0-20180914-dev.nvda-addon",
	...
	"ubi" => "unicodeBrailleInput-2.9.nvda-addon",
	"ubi-dev" => "unicodeBrailleInput-2.9.nvda-addon",
	...
	"vlc-dev" => "https://github.com/javidominguez/VLC/releases/download/2.7dev/VLC-2.7dev.multilanguage.nvda-addon",
	"vent" => "Ventrilo-1.0-dev.nvda-addon",
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/18.10/wintenApps-18.10.1.nvda-addon",
