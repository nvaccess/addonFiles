...
$addons = array(
	...
	"cac" => "http://cyber25.free.fr/nvda-addons/clock-18.12.nvda-addon",
	"cac-dev" => "http://cyber25.free.fr/nvda-addons/clock-18.12-dev.nvda-addon",
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.6/clipContentsDesigner-8.6.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.6/clipContentsDesigner-8.6.nvda-addon",
	"ccd-o" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/7.2/clipContentsDesigner-7.2.nvda-addon",
	"ckbl" => "https://github.com/abdel792/sayCurrentKeyboardLanguage/releases/download/v1.8/sayCurrentKeyboardLanguage-1.8.nvda-addon",
	"cr" => "columnsReview-3.0-20181208-dev.nvda-addon",
	"cr-dev" => "columnsReview-3.0-20181208-dev.nvda-addon",
	...
	"dw" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.1/dayOfTheWeek-6.1.nvda-addon",
	"dw-dev" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.1/dayOfTheWeek-6.1.nvda-addon",
	"dx" => "dropbox-4.3.nvda-addon",
	"dx-dev" => "dropbox-4.3.nvda-addon",
	"earia" => "https://github.com/jmdaweb/enhancedAria/releases/download/v2.2/enhancedAria-2.2.nvda-addon",
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.17/eMule-3.17.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.17/eMule-3.17.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/8.4/emoticons-8.4.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/9.2-dev/emoticons-9.2-dev.nvda-addon",
	"emo-o" => "https://github.com/nvdaes/emoticons/releases/download/6.5/emoticons-6.5.nvda-addon",
	"etn" => "easyTableNavigator-1.2.nvda-addon",
	"etn-dev" => "easyTableNavigator-1.2.nvda-addon",
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/18.12/enhancedTouchGestures-18.12.nvda-addon",
	"ets-dev" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/18.12/enhancedTouchGestures-18.12.nvda-addon",
	"ew" => "extendedWinamp-1.1.nvda-addon",
	"fh" => "https://github.com/nvdajp/focusHighlight/releases/download/5.4/focusHighlight-5.4.nvda-addon",
	"fh-dev" => "https://github.com/nvdajp/focusHighlight/releases/download/5.4/focusHighlight-5.4.nvda-addon",
	"gc" => "goldenCursor-3.3.nvda-addon",
	"gc-dev" => "goldenCursor-3.3.nvda-addon",
	"gl" => "https://github.com/nvdaaddons/nvdaaddons.github.io/wiki/guideLines",
	"gwv" => "https://github.com/josephsl/goldWave/releases/download/18.12/goldwave-18.12.nvda-addon",
	"gwv-dev" => "https://github.com/josephsl/goldWave/releases/download/18.12/goldwave-18.12.nvda-addon",
	"it" => "instantTranslate-4.2-dev.nvda-addon",
	"it-dev" => "instantTranslate-4.2-dev.nvda-addon",
	"indentnav" => "https://github.com/mltony/nvda-indent-nav/releases/download/v1.3/IndentNav-1.3.nvda-addon",
	"inputlock" => "https://github.com/jmdaweb/inputLock/releases/download/v1.4/inputLock-1.4.nvda-addon",
	...
	"mp3dc" => "https://github.com/abdel792/mp3DirectCut/releases/download/v4.2/mp3DirectCut-4.2.nvda-addon",
	"mp3dc-dev" => "https://github.com/abdel792/mp3DirectCut/releases/download/v4.2/mp3DirectCut-4.2.nvda-addon",
	...
	"nvda3208" => "addonUpdater-18.12.2.nvda-addon",
	"nvda7857" => "screenCurtain-20181123.nvda-addon",
	"nvdaremote" => "https://nvdaremote.com/remote-2.2.nvda-addon",
	"objLoc" => "https://github.com/josephsl/objLocationTones/releases/download/18.12/objLocTones-18.12.nvda-addon",
	"objPad" => "https://github.com/josephsl/objPad/releases/download/18.12/objPad-18.12.nvda-addon",
	"objPad-dev" => "https://github.com/josephsl/objPad/releases/download/18.12/objPad-18.12.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/12.1/placeMarkers-12.1.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/12.1/placeMarkers-12.1.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/6.1/readFeeds-6.1.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/6.1/readFeeds-6.1.nvda-addon",
	"rf-o" => "https://github.com/nvdaes/readFeeds/releases/download/4.5/readFeeds-4.5.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/18.12/resourceMonitor-18.12.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/18.12/resourceMonitor-18.12.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/4.4/reportSymbols-4.4.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/4.4/reportSymbols-4.4.nvda-addon",
	...
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/18.12/stationPlaylist-18.12.2.nvda-addon",
	"spl-lts18" => "https://github.com/josephsl/stationPlaylist/releases/download/18.11/stationPlaylist-18.09.5C-lts.nvda-addon",
	...
	"st" => "systrayList-3.1.nvda-addon",
	"st-dev" => "systrayList-3.1.nvda-addon",
	...
	"tbx" => "toolbarsExplorer-1.0.nvda-addon",
	"tbx-dev" => "toolbarsExplorer-1.1-20181208-dev.nvda-addon",
	"textnav" => "https://github.com/mltony/nvda-text-nav/releases/download/v1.0/textnav-1.0.nvda-addon",
	...
	"ubi" => "unicodeBrailleInput-2.10.nvda-addon",
	"ubi-dev" => "unicodeBrailleInput-2.10.nvda-addon",
	"VR" => "virtualRevision-2.3.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/18.12/wintenApps-18.12.1.nvda-addon",
