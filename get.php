...
$addons = array(
	...
	"dw" => "dayOfTheWeek-1.1-dev.nvda-addon",
	"dw-dev" => "dayOfTheWeek-1.1-dev.nvda-addon",
	"dx" => "dropbox-3.1.nvda-addon",
	"dx-dev" => "dropbox-4.0-dev.nvda-addon",
	"em" => "eMule-2.7.nvda-addon",
	"em-dev" => "eMule-2.7.nvda-addon",
	"emo" => "emoticons-4.2.nvda-addon",
	"emo-dev" => "emoticons-4.2.nvda-addon",
	...
	"spl" => "stationPlaylist-5.5.nvda-addon",
	...
	"vlc" => "VLC-0.7en.nvda-addon",
	"vent" => "Ventrilo-1.0-dev.nvda-addon",
	"w10-dev" => "wintenApps-15.9.nvda-addon",
