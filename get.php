...
$addons = array(
	...
	"cae" => "https://github.com/javidominguez/Calibre/releases/download/2.7/calibre-2.7.nvda-addon",
	"cae-dev" => "https://github.com/javidominguez/Calibre/releases/download/dev220326/calibre-dev220326.nvda-addon",
	"chari" => "https://github.com/CyrilleB79/charInfo/releases/download/V2.0/charInfo-2.0.nvda-addon",
	"chari-dev" => "https://github.com/CyrilleB79/charInfo/releases/download/V2.0/charInfo-2.0.nvda-addon",
	"clsel" => "https://github.com/tspivey/classicSelection/releases/download/v1.3/classicSelection-1.3.nvda-addon",
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/17.0/clipContentsDesigner-17.0.nvda-addon",
	...
	"cr" => "https://github.com/ABuffEr/columnsReview/releases/download/v5.0/columnsReview-5.0.nvda-addon",
	"cr-dev" => "https://github.com/ABuffEr/columnsReview/releases/download/20230217-dev/columnsReview-20230217-dev.nvda-addon",
	...
	"cua" => "https://github.com/nvdaes/controlUsageAssistant/releases/download/2023.02.19/controlUsageAssistant-2023.02.19.nvda-addon",
	...
	"cursorLocator" => "https://github.com/nvdaes/cursorLocator/releases/download/3.0/cursorLocator-3.0.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/emule/releases/download/7.0/eMule-7.0.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/emule/releases/download/6.0-dev/eMule-6.0-dev.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/16.0/emoticons-16.0.nvda-addon",
	...
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/23.02/enhancedTouchGestures-23.02.1.nvda-addon",
	"etn" => "https://github.com/CoBC/easyTableNavigator-1/releases/download/2.4/easyTableNavigator-2.4.nvda-addon",
	"etn-dev" => "https://github.com/CoBC/easyTableNavigator-1/releases/download/2.4/easyTableNavigator-2.4.nvda-addon",
	"evttracker" => "https://github.com/josephsl/evtTracker/releases/download/23.02/evtTracker-23.02.1.nvda-addon",
	"ew" => "https://github.com/beqabeqa473/extendedWinamp/releases/download/v2.2/extendedWinamp-2.2.nvda-addon",
	"fh" => "https://github.com/nvdajp/focusHighlight/releases/download/6.6/focusHighlight-6.6.nvda-addon",
	...
	"moz" => "https://github.com/javidominguez/MozillaScripts/releases/download/1.18/Mozilla-1.18.nvda-addon",
	...
	"nb" => "https://github.com/ABuffEr/noBeepsSpeechMode/releases/download/v5.3/noBeepsSpeechMode-5.3.nvda-addon",
	"nb-old" => "https://github.com/ABuffEr/noBeepsSpeechMode/releases/download/v4.0/noBeepsSpeechMode-4.0.nvda-addon",
	"ndtt" => "https://github.com/CyrilleB79/NVDA-Dev-Test-Toolbox/releases/download/V3.2/nvdaDevTestToolbox-3.2.nvda-addon",
	"newfon" => "https://github.com/DraganRatkovich/newfon/releases/download/2023.1/newfon-2023.1.nvda-addon",
	"NotepadPlusPlus" => "https://files.derekriemer.com/NotepadPlusPlus-2022.05.1.nvda-addon",
	"numpadNav" => "https://github.com/opensourcesys/numpadNavMode/releases/download/v23.0/numpadNavMode-23.0.nvda-addon",
	"nvda3208" => "https://github.com/josephsl/addonUpdater/releases/download/23.02/addonUpdater-23.02.1.nvda-addon",
	...
	"objLoc" => "https://github.com/josephsl/objLocationTones/releases/download/23.02/objLocTones-23.02.1.nvda-addon",
	"objPad" => "https://github.com/josephsl/objPad/releases/download/23.02/objPad-23.02.1.nvda-addon",
	"ocr" => "https://github.com/lukaszgo1/nvda-ocr/releases/download/v2.2/ocr-2.2.nvda-addon",
	"officedesk" => "https://github.com/josephsl/officeDesk/releases/download/23.02/officeDesk-23.02.1.nvda-addon",
	"oid-dev" => "https://github.com/larry801/online_ocr/releases/download/0.17-dev/onlineOCR-0.17-dev.nvda-addon",
	"outlookextended" => "https://github.com/CyrilleB79/outlookExtended/releases/download/V1.10/outlookExtended-1.10.nvda-addon",
	"outlookextended-dev" => "https://github.com/CyrilleB79/outlookExtended/releases/download/V1.10/outlookExtended-1.10.nvda-addon",
	"pckbbrl" => "https://github.com/nvdaes/pcKbBrl/releases/download/2023.02.23/pcKbBrl-2023.02.23.nvda-addon",
	...
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/23.02/resourceMonitor-23.02.1.nvda-addon",
	...
	"searchwith" => "https://github.com/ibrahim-s/searchWith/releases/download/v2.3/searchWith-2.3.nvda-addon",
	"sentencenav" => "https://github.com/mltony/nvda-sentence-nav/releases/download/v2.12/SentenceNav-2.12.nvda-addon",
	"skype" => "https://www.dlee.org/skype/NVDA/skype.nvda-addon",
	"smb" => "https://github.com/Sao-Mai-Center/SMB/releases/download/22.8/SMB-22.8.nvda-addon",
	"soundsplitter" => "https://github.com/josephsl/soundSplitter/releases/download/23.02/soundSplitter-23.02.1.nvda-addon",
	"spie" => "https://www.nvaccess.org/files/nvda-addons/speechPlayerInEspeak-0.4.nvda-addon",
	"splogger" => "https://github.com/opensourcesys/speechLogger/releases/download/v23.0.0/speechLogger-23.0.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/23.02/stationPlaylist-23.02.1.nvda-addon",
	...
	"st" => "https://github.com/ruifontes/systrayList/releases/download/2023.02/systrayList-2023.02.nvda-addon",
	...
	"tbx" => "https://github.com/ABuffEr/toolbarsExplorer/releases/download/v1.7/toolbarsExplorer-1.7.nvda-addon",
	"tbx-dev" => "https://github.com/ABuffEr/toolbarsExplorer/releases/download/20230217-dev/toolbarsExplorer-20230217-dev.nvda-addon",
	...
	"trainingkbdcmd" => "https://github.com/ibrahim-s/trainingNvdaCommands/releases/download/2.8/trainingKeyboardCommands-2.8.nvda-addon",
