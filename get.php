...
$addons = array(
    ...
    "gwv" => "goldwave-1.1.nvda-addon",
    "gwv-dev" => "goldwave-1.2-dev.nvda-addon",
    "it" => "instantTranslate-2.2beta2.nvda-addon",
    "it-dev" => "instantTranslate-3.0-dev.nvda-addon",
    "nb" => "NoBeepsSpeechMode-1.4.nvda-0addon",
    ...
    "spl-dev" => "StationPlaylist-1.0-dev-20131222.nvda-addon",
