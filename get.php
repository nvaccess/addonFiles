...
$addons = array(
	...
	"ccd" => "https://github.com/nvdaaddons/clipContentsDesigner/releases/download/v4.1/clipContentsDesigner-4.1.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/5.0-dev/clipContentsDesigner-5.0-dev.nvda-addon",
	...
	"em" => "https://github.com/nvdaaddons/eMule/releases/download/3.3/eMule-3.3.nvda-addon",
	"em-dev" => "https://github.com/nvdaaddons/eMule/releases/download/3.3/eMule-3.3.nvda-addon",
	"emo" => "https://github.com/nvdaaddons/emoticons/releases/download/4.7/emoticons-4.7.nvda-addon",
	"emo-dev" => "https://github.com/nvdaaddons/emoticons/releases/download/4.7/emoticons-4.7.nvda-addon",
	"etn" => "easyTableNavigator-1.1.nvda-addon",
	"etn-dev" => "easyTableNavigator-1.0-dev.nvda-addon",
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/16.12/enhancedTouchGestures-16.12.nvda-addon",
	...
	"pm" => "https://github.com/nvdaaddons/placeMarkers/releases/download/6.6/placeMarkers-6.6.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/7.2-dev/placeMarkers-7.2-dev.nvda-addon",
	"qb-dev" => "http://files.nvaccess.org/nvda-addons/quickBooks2014-2014.4.7.nvda-addon",
	"rf" => "https://github.com/nvdaaddons/readFeeds/releases/download/2.10/readFeeds-2.10.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/3.0-dev/readFeeds-3.0-dev.nvda-addon",
	"rm" => "resourceMonitor-16.10.nvda-addon",
	"rm-dev" => "resourceMonitor-16.10.nvda-addon",
	"rs-dev" => "rapidSettings-2.0dev.nvda-addon",
	"rsy" => "https://github.com/nvdaaddons/reportSymbols/releases/download/1.1/reportSymbols-1.1.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/2.0-dev/reportSymbols-2.0-dev.nvda-addon",
	"st" => "systrayList-1.8.nvda-addon",
	"st-dev" => "systrayList-2.0-dev.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/16.12.1/stationPlaylist-16.12.1.nvda-addon",
	"spl-dev" => "stationPlaylist-17.1-dev20161217.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/16.12.2/wintenApps-16.12.2.nvda-addon",
