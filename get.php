...
$addons = array(
	...
	"ccd" => "clipContentsDesigner-3.4.nvda-addon",
	"ccd-dev" => "clipContentsDesigner-3.4.nvda-addon",
	"cr-dev" => "columnsReview-2.0.nvda-addon",
	"cua" => "controlUsageAssistant-2.1.nvda-addon",
	"dw" => "dayOfTheWeek-1.2.nvda-addon",
	"dw-dev" => "dayOfTheWeek-1.2.nvda-addon",
	"dx" => "dropbox-4.0.nvda-addon",
	"dx-dev" => "dropbox-4.0-dev.nvda-addon",
	"em" => "eMule-3.0.nvda-addon",
	"em-dev" => "eMule-3.0-dev.nvda-addon",
	"emo" => "emoticons-4.4.nvda-addon",
	"emo-dev" => "emoticons-4.4.nvda-addon",
