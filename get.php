...
$addons = array(
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/5.1/clipContentsDesigner-5.1.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/5.2-dev/clipContentsDesigner-5.2-dev.nvda-addon",
	...
	"em" => "https://github.com/nvdaes/eMule/releases/download/3.4/eMule-3.4.nvda-addon",
	"em-dev" => "https://github.com/nvdaes/eMule/releases/download/3.4/eMule-3.4.nvda-addon",
	"emo" => "https://github.com/nvdaes/emoticons/releases/download/5.4/emoticons-5.4.nvda-addon",
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/5.4/emoticons-5.4.nvda-addon",
	"etn" => "easyTableNavigator-1.1.nvda-addon",
	"etn-dev" => "easyTableNavigator-1.0-dev.nvda-addon",
	"ets" => "https://github.com/josephsl/enhancedTouchGestures/releases/download/17.03/enhancedTouchGestures-17.03.nvda-addon",
	...
	"gwv" => "https://github.com/josephsl/goldWave/releases/download/16.12/goldwave-16.12.nvda-addon",
	"gwv-dev" => "https://github.com/josephsl/goldWave/releases/download/16.12/goldwave-16.12.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/7.1/placeMarkers-7.1.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/7.1/placeMarkers-7.1.nvda-addon",
	"qb-dev" => "https://www.nvaccess.org/files/nvda-addons/quickBooks2014-2014.4.7.nvda-addon",
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/3.1/readFeeds-3.1.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/3.1/readFeeds-3.1.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/17.02/resourceMonitor-17.02.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/17.02/resourceMonitor-17.02.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/2.1/reportSymbols-2.1.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/2.1/reportSymbols-2.1.nvda-addon",
	"st" => "systrayList-1.8.nvda-addon",
	"st-dev" => "systrayList-2.0-dev.nvda-addon",
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/17.04/stationPlaylist-17.04.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/17.03.2/wintenApps-17.03.2.nvda-addon",
