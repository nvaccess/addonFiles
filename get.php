...
$addons = array(
	...
	"cac" => "https://github.com/hkatic/clock/releases/download/v19.01.1-dev/clock-19.01.1-dev.nvda-addon",
	"cac-dev" => "https://github.com/hkatic/clock/releases/download/v19.01.1-dev/clock-19.01.1-dev.nvda-addon",
	...
	"ccd" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.7/clipContentsDesigner-8.7.nvda-addon",
	"ccd-dev" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/8.7/clipContentsDesigner-8.7.nvda-addon",
	"ccd-o" => "https://github.com/nvdaes/clipContentsDesigner/releases/download/7.2/clipContentsDesigner-7.2.nvda-addon",
	"ckbl" => "https://github.com/abdel792/sayCurrentKeyboardLanguage/releases/download/v1.8.2/sayCurrentKeyboardLanguage-1.8.2.nvda-addon",
	...
	"dw" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.2.1/dayOfTheWeek-6.2.1.nvda-addon",
	"dw-dev" => "https://github.com/abdel792/dayOfTheWeek/releases/download/v6.2.1/dayOfTheWeek-6.2.1.nvda-addon",
	...
	"emo-dev" => "https://github.com/nvdaes/emoticons/releases/download/9.4-dev/emoticons-9.4-dev.nvda-addon",
	...
	"fh" => "https://github.com/nvdajp/focusHighlight/releases/download/5.5/focusHighlight-5.5.nvda-addon",
	"fh-dev" => "https://github.com/nvdajp/focusHighlight/releases/download/5.5/focusHighlight-5.5.nvda-addon",
	...
	"mp3dc" => "https://github.com/abdel792/mp3DirectCut/releases/download/v4.3.1/mp3DirectCut-4.3.1.nvda-addon",
	"mp3dc-dev" => "https://github.com/abdel792/mp3DirectCut/releases/download/v4.3.1/mp3DirectCut-4.3.1.nvda-addon",
	...
	"nvda3208" => "addonUpdater-19.01.1A.nvda-addon",
	...
	"pm" => "https://github.com/nvdaes/placeMarkers/releases/download/12.2.1/placeMarkers-12.2.1.nvda-addon",
	"pm-dev" => "https://github.com/nvdaes/placeMarkers/releases/download/12.2.1/placeMarkers-12.2.1.nvda-addon",
	...
	"rf" => "https://github.com/nvdaes/readFeeds/releases/download/6.2/readFeeds-6.2.nvda-addon",
	"rf-dev" => "https://github.com/nvdaes/readFeeds/releases/download/6.2/readFeeds-6.2.nvda-addon",
	"rf-o" => "https://github.com/nvdaes/readFeeds/releases/download/4.5/readFeeds-4.5.nvda-addon",
	"rm" => "https://github.com/josephsl/resourceMonitor/releases/download/19.01/resourceMonitor-19.01.nvda-addon",
	"rm-dev" => "https://github.com/josephsl/resourceMonitor/releases/download/19.01/resourceMonitor-19.01.nvda-addon",
	"rs-dev" => "rapidSettings-2.0-dev.nvda-addon",
	"rsy" => "https://github.com/nvdaes/reportSymbols/releases/download/4.5/reportSymbols-4.5.nvda-addon",
	"rsy-dev" => "https://github.com/nvdaes/reportSymbols/releases/download/4.5/reportSymbols-4.5.nvda-addon",
	...
	"spl" => "https://github.com/josephsl/stationPlaylist/releases/download/19.01/stationPlaylist-19.01.1.nvda-addon",
	"spl-lts18" => "https://github.com/josephsl/stationPlaylist/releases/download/19.01/stationPlaylist-18.09.6A-lts.nvda-addon",
	...
	"st" => "systrayList-3.2.nvda-addon",
	"st-dev" => "systrayList-3.2.nvda-addon",
	...
	"tbx" => "toolbarsExplorer-1.1.nvda-addon",
	"tbx-dev" => "toolbarsExplorer-1.2-20190102-dev.nvda-addon",
	...
	"w10" => "https://github.com/josephsl/wintenApps/releases/download/19.01/wintenApps-19.01.1.nvda-addon",
	"w10-dev" => "https://www.josephsl.net/files/nvdaaddons/getupdate.php?file=w10-dev",
	"wetp" => "http://www.nvda.it/files/plugin/weather_plus4.8.nvda-addon",
